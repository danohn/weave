...
def upgrade() -> None:
    ...
    with op.batch_alter_table("preauth_tokens") as batch_op:
        ...
        if "token_prefix" in columns:
            batch_op.alter_column("token_prefix", existing_type=sa.String(), nullable=False)
...
def downgrade() -> None:
    ...
    with op.batch_alter_table("preauth_tokens") as batch_op:
        ...
        if "token_hash" in columns:
            batch_op.alter_column("token_hash", existing_type=sa.String(), nullable=True)
        if "token_prefix" in columns:
            batch_op.alter_column("token_prefix", existing_type=sa.String(), nullable=True)
